...
<style>
  ...
  .tg{display:inline-block;margin-top:8px;color:#7BC4F3;font:600 13px/1 Manrope,system-ui,sans-serif;text-decoration:none;}
</style></head>
<body><div id="map"></div>
...
<script>
  ...
  function openTg(id){
    var c = byId[id];
    if (c && c.tg && window.ReactNativeWebView) window.ReactNativeWebView.postMessage(c.tg);
  }
