...
export type AreaDoc = {label?: string; sortOrder?: number};
...
/** Плоский упорядоченный список аффирмаций из документов Firestore — общая
 *  логика для хука и планировщика уведомлений (порядок должен совпадать,
 *  иначе «мысль на сегодня» в приложении и в пуше разойдутся). */
export function buildAffirmationList(
  byKey: Record<string, string[]>,
  areas: Record<string, AreaDoc>,
): Affirmation[] {
...
/** Собирает byKey-словарь из снапшота коллекции `affirmations`. */
